<header class="shadow" style="background-color: #232D3F; position: sticky; top: 0; z-index: 100;">
    <div class="container mx-auto flex justify-between items-center py-4 px-6">
        ...
        <div class="flex items-center space-x-4">
            ...
            <a href="uListKomik.php" class="text-white hover:underline">List Book</a>
            <a href="uLibrary.php" class="text-white hover:underline">My Library</a>
            <a href="../../view/uProfile.php">
