...
<body class="bg-gray-100">
    <div class="flex h-screen">
        ...
        <main class="flex-1 p-6">
            ...
            <a href="../../view/aView/aMenambahBuku.php">
                ...
                <table class="min-w-full bg-white border border-gray-200">
                    ...
                    <tbody>
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-2">Naruto</td>
                            <td class="px-4 py-2">Masashi Kishimoto</td>
                            <td class="px-4 py-2">Action</td>
                            <td class="px-4 py-2 text-blue-500">Edit | Delete</td>
                        </tr>
                        <tr class="border-b">
                            <td class="px-4 py-2">2</td>
                            <td class="px-4 py-2">One Piece</td>
                            <td class="px-4 py-2">Eiichiro Oda</td>
                            <td class="px-4 py-2">Adventure</td>
                            <td class="px-4 py-2 text-blue-500">Edit | Delete</td>
                        </tr>
                    </tbody>
                </table>
